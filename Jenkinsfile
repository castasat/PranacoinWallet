...
android (
    ...
    // Develop
    BUILD_COMMAND_DEV: 'export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-11.jdk/Contents/Home && ./gradlew clean assembleDevelopmentDebug assembleDevelopmentRelease getCommitMessage -PWEB_VIEW_DEBUGGING_ENABLED=true -PSCREENSHOT_DISABLED=false --no-daemon',
    // MajorCheck
