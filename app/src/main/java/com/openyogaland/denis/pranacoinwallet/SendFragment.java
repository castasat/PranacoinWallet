      ...
      Bundle savedInstanceState)
  {
    ...
    send.setOnClickListener(new View.OnClickListener()
    {
      ...
      public void onClick(View v)
      {
        ...
        String url1 = "http://95.213.191.196/api.php?action=sendprana&walletid=" + idOfUser
                      + "&recipientaddr=" + recepaddr + "&sum=" + amount;
        
        final RequestQueue requestQueue1 = Volley.newRequestQueue(context);
        
        StringRequest stringRequest1 = new StringRequest(Method.GET, url1, new Listener<String>()
        {
          @Override
