...
class PolicyFragment : AppCompatDialogFragment(), OnCheckedChangeListener, OnClickListener
{
  ...
  : View
  {
    ...
    val acceptPrivacyPolicyCheckBox = view.findViewById<CheckBox>(R.id.acceptPrivacyPolicyCheckBox)
  ...
  // setter
  fun setOnPrivacyPolicyAcceptedListener(onPrivacyPolicyAcceptedListener
                                         : OnPrivacyPolicyAcceptedListener)
  {
